...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Boss_ParryCounter);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Boss_ParryCounterFollowUpDecision);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Boss_BowAttackRestoreWeapon);
