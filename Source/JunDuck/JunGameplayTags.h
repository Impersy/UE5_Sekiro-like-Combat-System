...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_HeavyAttack_ComboWindow);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Jigen_ComboWindow);
...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Execution_Apply);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Execution_FinishCameraPullIn);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Execution_CameraRestore);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Death_Present);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Boss_Clear);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Boss_StopCombatBGM);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Boss_DangerAttack);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Monster_DangerAttack);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Wukong_ParryCounter);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Wukong_ParryCounterFollowUpDecision);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(Event_Notify_Wukong_BowAttackRestoreWeapon);
