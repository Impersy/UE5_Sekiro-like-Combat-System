...
public:
	...
	void StartRespawnFullBlackFadeOut();
	void HideDeathUI();
	...
	void ShowAirParryTutorialGuide();
	...
	void RestartPausedGame();
	void QuitPausedGame();
	void CompleteLevelIntroTransition();
...
private:
	...
	void BeginLevelIntroTransition();
	void UpdateCombatWidgets();
	void UpdateBossMapNotice();
	...
	bool bLevelIntroInputLocked = false;
	bool bBossMapNoticeCheckActive = true;
	bool bBossMapNoticeVolumeLogged = false;
