...
UCLASS()
class JUNDUCK_API AJunTutorialNPC : public AJunMonster, public IJunTutorialTargetInterface
{
	GENERATED_BODY()
...
public:
	...
	virtual void OnLockedOnBy(AJunPlayer* Player) override;
	...
	virtual bool ShouldPreventPlayerDeathForTutorial(const AJunPlayer* Player) const override;
	virtual void NotifyPlayerDrinkPotionForTutorial(AJunPlayer* Player) override;
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "TutorialNPC|Debug")
	bool bDebugTutorialTaskProgress = false;
